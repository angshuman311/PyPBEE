...
if __name__ == "__main__":
    ...
    #                           f'/scratch/04236/adeb/stampede2/PEER_UQ_Project/Software/{nltha.structure.name}',
    ...
    # nltha.collect_edps(analysis_case, pool_size, nltha.get_post_analysis_lists(analysis_case)[0])
    #
