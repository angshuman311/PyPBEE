...
xi_e = 0.01  # Self
K50_u_e = 4.3501e3  # Anoosh
Fult_u_e = 2.7377e3  # Anoosh
...
primary_design_vars = {'1': [5.51, 0.0223]}
...
damping_model['xi_i'] = ['damp_ratio'] * 4 + list(np.linspace(0.01, 1.0, 20))
damping_models.append(damping_model)
...
location_info['latitude'] = 37.751337
location_info['longitude'] = -121.141971
