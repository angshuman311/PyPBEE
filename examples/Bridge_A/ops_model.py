...
def main(model_input_dict):
    ...
    ops.uniaxialMaterial('Concrete01', 2001, -fpc_col_1_secdef_1, -0.0021795371673297504, -1.3, -0.005884823378103793)
    ...
    ops.uniaxialMaterial(steel_material, 3001, 69.144, 69.144, 29200.0, 0.01, 0.01, 20., 0.925, 0.15)
    ops.uniaxialMaterial(steel_material, 3002, 69.144, 69.144, 29200.0, 0.01, 0.01, 20., 0.925, 0.15)
    ops.uniaxialMaterial(steel_material, 3003, 69.144, 69.144, 29200.0, 0.01, 0.01, 20., 0.925, 0.15)
    ops.uniaxialMaterial(steel_material, 3004, 69.144, 69.144, 29200.0, 0.01, 0.01, 20., 0.925, 0.15)
    ops.uniaxialMaterial(steel_material, 3005, 69.144, 69.144, 29200.0, 0.01, 0.01, 20., 0.925, 0.15)
    ops.uniaxialMaterial(steel_material, 3006, 69.144, 69.144, 29200.0, 0.01, 0.01, 20., 0.925, 0.15)
    ops.uniaxialMaterial(steel_material, 3007, 69.144, 69.144, 29200.0, 0.01, 0.01, 20., 0.925, 0.15)
    ops.uniaxialMaterial(steel_material, 3008, 69.144, 69.144, 29200.0, 0.01, 0.01, 20., 0.925, 0.15)
    ops.uniaxialMaterial(steel_material, 3009, 69.144, 69.144, 29200.0, 0.01, 0.01, 20., 0.925, 0.15)
    ops.uniaxialMaterial(steel_material, 3010, 69.144, 69.144, 29200.0, 0.01, 0.01, 20., 0.925, 0.15)
    ops.uniaxialMaterial(steel_material, 3011, 69.144, 69.144, 29200.0, 0.01, 0.01, 20., 0.925, 0.15)
    ops.uniaxialMaterial(steel_material, 3012, 69.144, 69.144, 29200.0, 0.01, 0.01, 20., 0.925, 0.15)
